...
def generate_launch_description():
    ...
    twist_mux_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "config_lock": os.path.join(bumperbot_controller_pkg, "config", "twist_mux_locks.yaml"),
            "config_joy": os.path.join(bumperbot_controller_pkg, "config", "twist_mux_joys.yaml"),
            "use_sim_time": LaunchConfiguration("use_sim_time")
        }.items()
    )  
