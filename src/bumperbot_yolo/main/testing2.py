...
class ImageProcessing:
    ...
    def get_and_increment_counter(self):
        counter_file = os.path.join("/home/shourya/bumperbot/src/bumperbot_yolo/setup", "counter_inference.txt")
        os.makedirs("/home/shourya/bumperbot/src/bumperbot_yolo/setup", exist_ok=True)
        count = 1
